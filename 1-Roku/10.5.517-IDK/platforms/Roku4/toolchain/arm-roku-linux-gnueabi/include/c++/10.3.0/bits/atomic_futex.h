...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  private:
    ...
    {
      return _M_load_and_test_for(__assumed, __operand, __equal, __mo,
				    false, chrono::nanoseconds{});
    }
    ...
    template<typename _Rep, typename _Period>
    unsigned
    _M_load_and_test_for_impl(unsigned __assumed, unsigned __operand,
	bool __equal, memory_order __mo,
	const chrono::duration<_Rep, _Period>& __rtime)
    {
      return _M_load_and_test_for(__assumed, __operand, __equal, __mo,
  ...
  public:
	...
	return true;
      ...
      __i = _M_load_and_test_for_impl(__i, __val, true, __mo, __rtime);
    ...
    template<typename _Clock, typename _Duration>
      ...
      {
	return _M_load_when_equal_for(__val, __mo,
					__atime - _Clock::now());
    }
